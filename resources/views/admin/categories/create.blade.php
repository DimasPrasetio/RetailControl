    ...
    <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200/80">
        <form method="POST" action="{{ route('admin.categories.store') }}">
            ...
            <div class="mb-4">
                ...
                <select name="parent_id" class="w-full rounded-xl border border-gray-200 px-3.5 py-2.5 text-sm shadow-sm focus:border-blue-400 focus:ring focus:ring-blue-100">
            ...
            <div class="mb-4">
                <label class="mb-1.5 block text-sm font-medium text-gray-700">Kode <span class="text-gray-400">(opsional, unik)</span></label>
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('admin.categories.index') }}" class="rounded-xl border border-gray-200 px-5 py-2.5 text-sm font-medium text-gray-600 transition hover:bg-gray-50">Batal</a>
            </div>
        </form>
    </div>
</div>
