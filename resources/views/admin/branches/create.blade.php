...
<div class="max-w-3xl overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-xl shadow-indigo-500/10">
    <div class="border-b border-gray-100 px-6 py-4">
        <h2 class="text-base font-semibold text-gray-900">Cabang Baru</h2>
        <p class="mt-0.5 text-sm text-gray-500">Gudang utama akan dibuat otomatis saat cabang disimpan.</p>
    </div>
