...
@section('page-title', 'Tambah Definisi Atribut')

@section('content')

<div class="mb-6">
    <a href="{{ route('admin.attribute-definitions.index', array_filter(['tenant_id' => $selectedTenantId])) }}"
...
<div class="max-w-4xl overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-xl shadow-indigo-500/10">
    <div class="border-b border-gray-100 px-6 py-4">
        <h2 class="text-base font-semibold text-gray-900">Definisi Atribut Baru</h2>
        <p class="mt-0.5 text-sm text-gray-500">Tambahkan field dinamis untuk kategori produk tertentu.</p>
    </div>

    <form method="POST" action="{{ route('admin.attribute-definitions.store') }}">
        @csrf
