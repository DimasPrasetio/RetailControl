                                ...
                                <div class="flex items-center justify-end gap-1.5">
                                    @can('view', $item)
                                        <a href="{{ route('admin.items.show', $item) }}"
                                            class="inline-flex items-center gap-1 rounded-lg bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-600 shadow-sm shadow-blue-100/50 transition hover:bg-blue-100 hover:shadow-md hover:shadow-blue-200/50">
                                            <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    ...
                                    @if($item->is_active)
                                        @can('deactivate', $item)
                                            <form method="POST" action="{{ route('admin.items.deactivate', $item) }}"
                                                ...
                                                @csrf @method('PATCH')
                                                <button type="submit"
                                                    class="inline-flex items-center gap-1 rounded-lg bg-red-50 px-3 py-1.5 text-xs font-semibold text-red-600 shadow-sm shadow-red-100/50 transition hover:bg-red-100 hover:shadow-md hover:shadow-red-200/50">
                                                    <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
